%% Create interpolated SSD patterns and plot raw points (Figures 2b, S2, & S3)
...
%% MED OFF and ON averaged (Figures 2b & S3)
...
%% MED OFF and ON separately (Figure S2a)
...
%% STIM OFF and ON separately (Figure S2b)
