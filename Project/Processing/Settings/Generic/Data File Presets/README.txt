This is where information about the preprocessed data to be analysed is stored.

Here, there is a json file for each group of recordings.
In each json file, the preprocessed data to analyse are given as a list of
